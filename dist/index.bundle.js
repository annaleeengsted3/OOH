...
/******/ 	return __webpack_require__(__webpack_require__.s = "./ModuleIndex.ts");
/******/ })
/************************************************************************/
/******/ ({
...
"use strict";
eval("\nvar __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\nvar __generator = (this && this.__generator) || function (thisArg, body) {\n    var _ = { label: 0, sent: function() { if (t[0] & 1) throw t[1]; return t[1]; }, trys: [], ops: [] }, f, y, t, g;\n    return g = { next: verb(0), \"throw\": verb(1), \"return\": verb(2) }, typeof Symbol === \"function\" && (g[Symbol.iterator] = function() { return this; }), g;\n    function verb(n) { return function (v) { return step([n, v]); }; }\n    function step(op) {\n        if (f) throw new TypeError(\"Generator is already executing.\");\n        while (_) try {\n            if (f = 1, y && (t = op[0] & 2 ? y[\"return\"] : op[0] ? y[\"throw\"] || ((t = y[\"return\"]) && t.call(y), 0) : y.next) && !(t = t.call(y, op[1])).done) return t;\n            if (y = 0, t) op = [op[0] & 2, t.value];\n            switch (op[0]) {\n                case 0: case 1: t = op; break;\n                case 4: _.label++; return { value: op[1], done: false };\n                case 5: _.label++; y = op[1]; op = [0]; continue;\n                case 7: op = _.ops.pop(); _.trys.pop(); continue;\n                default:\n                    if (!(t = _.trys, t = t.length > 0 && t[t.length - 1]) && (op[0] === 6 || op[0] === 2)) { _ = 0; continue; }\n                    if (op[0] === 3 && (!t || (op[1] > t[0] && op[1] < t[3]))) { _.label = op[1]; break; }\n                    if (op[0] === 6 && _.label < t[1]) { _.label = t[1]; t = op; break; }\n                    if (t && _.label < t[2]) { _.label = t[2]; _.ops.push(op); break; }\n                    if (t[2]) _.ops.pop();\n                    _.trys.pop(); continue;\n            }\n            op = body.call(thisArg, _);\n        } catch (e) { op = [6, e]; y = 0; } finally { f = t = 0; }\n        if (op[0] & 5) throw op[1]; return { value: op[0] ? op[1] : void 0, done: true };\n    }\n};\nObject.defineProperty(exports, \"__esModule\", { value: true });\n__webpack_require__(/*! ./stylesheets/global.scss */ \"./stylesheets/global.scss\");\nvar DataLoader_1 = __webpack_require__(/*! ./DataLoader */ \"./DataLoader.ts\");\nvar DataURLs_1 = __webpack_require__(/*! ./DataURLs */ \"./DataURLs.ts\");\n// import ModuleWaveEffect from \"./ModuleWaveEffect\";\nvar ModuleIndex = /** @class */ (function () {\n    function ModuleIndex() {\n        var _this = this;\n        this._desktop = document.querySelector(\"picture .desktop-src\");\n        this._tabland = document.querySelector(\"picture .tabland-src\");\n        this._tabport = document.querySelector(\"picture .tabport-src\");\n        this._mobland = document.querySelector(\"picture .mobland-src\");\n        this._mobport = document.querySelector(\"picture .mobport-src\");\n        this.hero = document.querySelector(\"img.imgA\");\n        // private _moduleEffect: ModuleWaveEffect;\n        this._URLimageToDisplace = \"../assets/indexbg.jpg\";\n        this._URLDmap = \"../assets/water.png\";\n        this._DOMContainer = document.querySelector(\"#index .pixi-container\");\n        // private setupPixi() {\n        //   console.log(\"setting up pixi\");\n        //   this._moduleEffect = new ModuleWaveEffect(\n        //     this._URLimageToDisplace,\n        //     this._URLDmap,\n        //     this._DOMContainer\n        //   );\n        //   this._moduleEffect.awake();\n        // }\n        this.addFade = function () {\n            _this.hero.classList.add(\"hide\");\n        };\n        this.removeFade = function () {\n            _this.hero.classList.remove(\"hide\");\n        };\n        this._dataURLs = new DataURLs_1.DataURLs().getURLS;\n        this._url = this._dataURLs.index;\n        this._urlNextEvent = this._dataURLs.kommende_events;\n        this._viewport = window.innerWidth;\n        this.getDatafromJSON();\n        // if (this._viewport > 1025) {\n        //   this.setupPixi();\n        // }\n        document\n            .querySelector(\"header\")\n            .addEventListener(\"mouseover\", this.addFade);\n        document\n            .querySelector(\"header\")\n            .addEventListener(\"mouseout\", this.removeFade);\n    }\n    ModuleIndex.prototype.getDatafromJSON = function () {\n        return __awaiter(this, void 0, void 0, function () {\n            return __generator(this, function (_a) {\n                switch (_a.label) {\n                    case 0:\n                        this._dataLoader = new DataLoader_1.default(this._url);\n                        return [4 /*yield*/, this._dataLoader.loadData()];\n                    case 1:\n                        _a.sent();\n                        this._data = this._dataLoader.getData;\n                        this.getNextEventData();\n                        return [2 /*return*/];\n                }\n            });\n        });\n    };\n    ModuleIndex.prototype.getNextEventData = function () {\n        return __awaiter(this, void 0, void 0, function () {\n            return __generator(this, function (_a) {\n                switch (_a.label) {\n                    case 0:\n                        this._dataLoader = new DataLoader_1.default(this._urlNextEvent);\n                        return [4 /*yield*/, this._dataLoader.loadData()];\n                    case 1:\n                        _a.sent();\n                        this._dataNextEvent = this._dataLoader.getData;\n                        this.showInitialData();\n                        return [2 /*return*/];\n                }\n            });\n        });\n    };\n    ModuleIndex.prototype.showInitialData = function () {\n        this._desktop.setAttribute(\"srcset\", \"\" + this._data[0].desktop_fallback.guid);\n        this._tabland.setAttribute(\"srcset\", \"\" + this._data[0].tablet_land.guid);\n        this._tabport.setAttribute(\"srcset\", \"\" + this._data[0].tablet_port.guid);\n        this._mobport.setAttribute(\"src\", \"\" + this._data[0].mobile_port.guid);\n        this._mobland.setAttribute(\"srcset\", \"\" + this._data[0].mobile_land.guid);\n        document.querySelector(\".index-txt\").innerHTML = \"\" + this._data[0].forside_text;\n        document.querySelector(\".index-next-event h3\").innerHTML = this._dataNextEvent[0].dato + \"/\" + this._dataNextEvent[0].dato_maaned + \": \" + this._dataNextEvent[0].title.rendered;\n        this._nextEventLink.href = \"\";\n    };\n    return ModuleIndex;\n}());\nexports.default = ModuleIndex;\nvar index = new ModuleIndex();\n\n\n//# sourceURL=webpack:///./ModuleIndex.ts?");
...
eval("\n\n//# sourceURL=webpack:///./stylesheets/global.scss?");
